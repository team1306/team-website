...
interface props {
    itemsArray: ItemData[];
    changeItems: (newItems: ItemData[]) => void;
}

export default function EditPurchase({ itemsArray, changeItems }: props) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger render={<Button className="ml-auto bg-zinc-100 text-black text-lg hover:bg-zinc-300 rounded-lg"><Pencil /></Button>}></DialogTrigger>
            <DialogContent className="bg-red-900 w-fit max-w-fit sm:max-w-fit">
                <h1 className="text-2xl text-zinc-100 font-bold">Edit Purchase</h1>
                    ...
                    <div className="flex flex-col gap-2 h-full">
                        ...
                        <Card className="w-md gap-0 bg-mist-600 text-zinc-100 p-2 flex-none">
                            ...
                            <div className="flex">
                                ...
                                <Button className="w-fit text-base bg-zinc-100 text-black border-0 ml-auto hover:bg-zinc-300" onClick={handleSave}>Save</Button>
                            </div>
