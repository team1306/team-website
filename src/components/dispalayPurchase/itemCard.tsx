        ...
        return (
            <Card className="bg-mist-700 h-fit gap-0 p-0 mb-2">
                <div className="pl-2 pt-2">
                    ...
                    <CardDescription className="text-sm text-zinc-300">x{quantity} at ${cost}</CardDescription>
                </div>
                <Card className="mt-2 p-1 mb-0 bg-red-900 rounded-t-none rounded-b-md">
                    <h1 className="text-sm font-jetbrains text-zinc-100">{comments}</h1>
                </Card>
            </Card>
        );
    }
